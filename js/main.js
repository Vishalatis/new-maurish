(function ($) {
  ...
  $(function () {
    $(".topbar-dropdown__btn").on("click", function () {
      $(this)
        ...
        .toggleClass("topbar-dropdown--opened");
    });
  ...
  $(function () {
    ...
    $(".indicator--trigger--click .drop-search__input").on(
      "keydown",
      function (event) {
        if (event.which === 27) {
  ...
  $(function () {
    ...
    if (mobileSearch.length) {
      ...
      mobileSearch
        .find(".mobile-header__search-button--close")
        .on("click", function () {
          mobileSearch.removeClass("mobile-header__search--opened");
        });
  ...
  $(function () {
    ...
    const CDepartments = function (element) {
      ...
      $(".departments__links-wrapper", this.element).on(
        "transitionend",
        function (event) {
  ...
  $(document).ready(function () {
    $(".testimonial-carousel").owlCarousel({
      ...
      dotsEach: true, // Enable each dot for each slide
    });
  });
